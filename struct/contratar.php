  ...
  <div class="title2"><spam class="btn btn3" onclick="acton('<?php echo $resultado['N_Mod']; ?>','acao','voltar')">Voltar</spam></div>
  </div> 
  <div class="row"> 
  ...
  <spam class="btn btn2" onclick="acton(<?php echo $resultado['N_Mod']; ?>,'acao','contet')"><?php echo $resultado['Stat_mod']; ?></spam>
  </div>
